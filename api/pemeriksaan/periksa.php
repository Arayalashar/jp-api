...
if(isset($data->id_barang) && isset($data->id_spv) && isset($data->id_dokumen)) {
    ...
    if($stmt->execute()){
        ...
        // Notifikasi ke admin bahwa pemeriksaan telah selesai
        buat_notifikasi_role($koneksi, 'admin', 'Hasil Pemeriksaan QC', "Barang ID $id_barang telah selesai diperiksa oleh Supervisor QC dengan status: $status.");
