...
import '../../features/gudang/screens/riwayat_gudang_screen.dart';

import '../../features/admin/screens/admin_dashboard_screen.dart';
import '../../features/supir/screens/tugas_supir_screen.dart';
import '../../features/supir/screens/riwayat_supir_screen.dart';
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: _FloatingNavbar(
          ...
          onTap: (index) {
            ...
            if (index == 2) {
              if (_getNormalizedRole() == 'spv') {
                context.read<SpvProvider>().fetchRiwayat(widget.idUser);
              } else if (_getNormalizedRole() == 'supir') {
                context.read<SupirProvider>().fetchRiwayat(widget.idUser);
              }
            }
          },
          navData: navItems,
    ...
    switch (role) {
      case 'gudang':
        return [
          ...
          RiwayatGudangScreen(idGudang: widget.idUser),
      ...
      case 'supir':
        return [
          ...
          RiwayatSupirScreen(idSupir: widget.idUser),
          ProfilScreen(nama: widget.nama, role: widget.role, stats: _stats),
        ];
      case 'spv':
        return [
