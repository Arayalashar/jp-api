  ...
  Widget _buildPackingCard(GudangModel item) {
    ...
    return AnimatedContainer(
      ...
      decoration: isDone
          ...
          : BoxDecoration(color: LightTheme.surface, borderRadius: BorderRadius.circular(24), boxShadow: [BoxShadow(color: Colors.black.withValues(alpha: 0.05), blurRadius: 10, offset: const Offset(0, 4))], border: Border.all(color: LightTheme.border)),
      child: Column(
